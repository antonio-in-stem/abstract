...
guide and [`SPEC.md`](SPEC.md) disagree, the specification wins; every section
...
[`examples/`](examples/README.md), with the exact compiler output stored beside
it as `expected.json`.
...
Example project: [`examples/hello`](examples/hello).
...
SPEC 4.4. Example project: [`examples/types-tour`](examples/types-tour).
...
[`examples/groups-and-lists`](examples/groups-and-lists).
...
SPEC 4.9. Example project: [`examples/numbered-keys`](examples/numbered-keys).
...
[`examples/paths-and-blocks`](examples/paths-and-blocks).
...
[`examples/tables-and-wildcards`](examples/tables-and-wildcards).
...
[`examples/interpolation`](examples/interpolation).
...
SPEC 5.7. Example projects: [`examples/clones`](examples/clones) and
[`examples/clone-merge`](examples/clone-merge).
...
SPEC 6. Example projects: [`examples/logic-basics`](examples/logic-basics) and
[`examples/logic-version`](examples/logic-version).
...
[`examples/versions-overlays`](examples/versions-overlays) and
[`examples/instance-windows`](examples/instance-windows).
...
[`raw-data.md`](raw-data.md) for the full contract.

---

## 8. Output

SPEC 8. Full detail is in [`raw-data.md`](raw-data.md).
...
and is stable across 1.x releases.

---

## 10. Where to go next

- [`SPEC.md`](SPEC.md) — the normative specification, including the complete
  diagnostics catalogue (section 10) and the worked example (Appendix C).
- [`GRAMMAR.ebnf`](GRAMMAR.ebnf) — the complete grammar.
