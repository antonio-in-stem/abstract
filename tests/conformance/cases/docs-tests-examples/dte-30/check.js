...
// 1) editors/vscode/src/extension.js:103 - schema type regex actually shipped
const shipped = /\b(text|int|enum|file)\b(?=\s*\()/g;
// what 0.2 actually has (docs/abstract-language.md:67-79)
...
// 2) editors/vscode/src/extension.js:107 - logic keyword regex
...
// 3) editors/vscode/src/extension.js:6-20 - static completion list
...
const g = JSON.parse(fs.readFileSync("../../../project/editors/vscode/syntaxes/abstract.tmLanguage.json","utf8"));
