...
& $ABSTRACT compile examples/intermediate-library JSON
& $ABSTRACT compile examples/intermediate-library YML
& $ABSTRACT compile examples/intermediate-library RAW
```
