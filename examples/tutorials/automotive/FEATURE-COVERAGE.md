...
This matrix treats [`docs/reference/specification.md`](../../../docs/reference/specification.md) as normative. The
...
| 4.9 | numbered keys | `labels.1`, `labels.2` | `examples/features/numbered-keys` and YAML tests |
...
Ignored legacy tests remain as compatibility checks and are marked obsolete.
The active conformance corpus and automotive integration tests are the current
gates.
