...
```sh
abstract lint examples/tutorials/automotive
abstract compile examples/tutorials/automotive JSON
abstract compile examples/tutorials/automotive YML
abstract compile examples/tutorials/automotive RAW
```
...
```sh
abstract compile examples/tutorials/automotive/negative-cases/range JSON
abstract compile examples/tutorials/automotive/negative-cases/enum JSON
abstract compile examples/tutorials/automotive/negative-cases/ref JSON
abstract compile examples/tutorials/automotive/negative-cases/missing-asset JSON
abstract compile examples/tutorials/automotive/negative-cases/steering JSON
abstract compile examples/tutorials/automotive/negative-cases/performance JSON
```
