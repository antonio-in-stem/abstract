...
/**
 * Verification runner. Checks the RFC 8439 AEAD vector and then,
 ...
 *
 * <pre>
 * java -cp ... com.abstractlang.runtime.Selftest [bundle.abx key-material]
 * </pre>
 */
public final class Selftest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        versionOverlays();
        plainContainers();
        System.out.println("selftest: RFC 8439 AEAD vector and unit checks passed");
    ...
    private static void loadBundle(String path, String keyMaterial) throws Exception {
        byte[] key = AbstractKeys.fromKeyMaterial(keyMaterial);
